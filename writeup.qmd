...
#| fig-cap: "Plot of the predicted species distributions of Megarhyssa macrura, Tremex columba and their overlap, based on glm models including climatic variables."
...
# Outputs the dataframe as a kable 
overlapResults %>%
  kbl() %>%
  kable_styling(full_width = FALSE, position = "center")
...
plot(presence1, col = "#88CCEE", main = "Species Distribution Overlap",legend = FALSE)
